...
| **→ Release `cairn-retrieval` 0.1.0** ⏳ | Publish; the full engine story. Code + tests + examples + intents COMPLETE and green (local); publishing awaits Leo's explicit go (nothing to GitHub/PyPI until then). | — | — |
